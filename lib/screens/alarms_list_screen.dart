...
import '../widgets/alarm_list_screen_list_widget.dart';
...
class AlarmListScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState createState() => _AlarmListScreenState();
}

class _AlarmListScreenState extends ConsumerState<AlarmListScreen> with SingleTickerProviderStateMixin{
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          const Expanded(
            child: AlarmListScreenListWidget(),
          ),
          SizedBox(
            height: 0.025.sh,
          ),
